...
using Sanaclub.Application.Documents.GenerateEvolutionSheetPdf;

namespace Sanaclub.Api.Controllers;

[ApiController]
[Route("api/v1/evolution-sheets/{evolutionSheetId:guid}/documents")]
[Authorize]
public sealed class EvolutionSheetDocumentsController : ControllerBase
{
    private readonly ISender _sender;

    public EvolutionSheetDocumentsController(ISender sender)
    {
        _sender = sender;
    }
    ...
    public async Task<ActionResult<GeneratedDocumentResponse>> GeneratePdf(
        [FromRoute] Guid evolutionSheetId,
        CancellationToken cancellationToken)
    {
        ...
        var command = new GenerateEvolutionSheetPdfCommand
        {
            EvolutionSheetId = evolutionSheetId,
