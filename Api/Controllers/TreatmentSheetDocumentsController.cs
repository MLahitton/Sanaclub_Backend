...
using Sanaclub.Application.Documents.GenerateTreatmentSheetPdf;

namespace Sanaclub.Api.Controllers;

[ApiController]
[Route("api/v1/treatment-sheets/{treatmentSheetId:guid}/documents")]
[Authorize]
public sealed class TreatmentSheetDocumentsController : ControllerBase
{
    private readonly ISender _sender;

    public TreatmentSheetDocumentsController(ISender sender)
    {
        _sender = sender;
    }
    ...
    public async Task<ActionResult<GeneratedDocumentResponse>> GeneratePdf(
        [FromRoute] Guid treatmentSheetId,
        CancellationToken cancellationToken)
    {
        ...
        var command = new GenerateTreatmentSheetPdfCommand
        {
